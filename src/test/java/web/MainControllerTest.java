...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//*[@id=\"navbarSupportedContent\"]/div").string("1"));
    }
    ...
    public void addMessageToListTest() throws Exception{
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='40']/span").exists())
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='40']/span")
                        .string("fifth"))
                .andExpect(xpath("//*[@id=\"message-list\"]/div[@data-id=40]/i")
                        .string("#new one"));
    }
}
